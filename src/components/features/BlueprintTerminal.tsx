...
const BlueprintTerminal: React.FC<BlueprintTerminalProps> = ({ blueprint }) => {
    ...
    return (
        <div className={cn(
            ...
            theme === 'dark'
                ? 'bg-[#101828] border-zinc-700 text-gray-300'
                : 'bg-[#364153] border-zinc-600 text-gray-200'
        )}>
            {/* Terminal Header */}
            <div className={cn(
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-400 font-medium tracking-wide leading-none">{blueprint.title}</span>
                </div>
