    ...
    return (
        ...
        >
            <div className="bg-[#1E2939] border-b border-zinc-700 px-4 py-2 flex items-center justify-between">
                ...
                <span className="text-gray-500 text-xs font-medium uppercase tracking-widest leading-none pt-0.5">
                    {blueprint.title}
                </span>
            </div>
            ...
            <div className="bg-[#1E2939]/50 px-4 py-1.5 border-t border-zinc-800/50">
                <div className="flex items-center gap-2 text-[10px] text-gray-600 uppercase tracking-tighter">
